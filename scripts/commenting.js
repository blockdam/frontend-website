...
class Respond extends Commenting {
    ...
    insertNewThread() {
        ...
        tempComment.querySelector('.datetime').innerText = this.response.author + ' | ' + moment().format('D MMMM YYYY | HH:mm');
        tempComment.querySelector('#commment-template-text').innerText = this.response.content;
